...
import movieChannelACard from "./modules/movieChannelACard.js";
...
const myVM =(()=> {
    let vue_vm = new Vue ({
        ...
        mounted: function(){
            ...
            .then(data => {
            data.forEach(movieChannelA => this.movieChannelA.push(movieChannelA));
            })
     ...
     methods:{
        ...
        components: {
            "movieChannelA-card" : movieChannelACard      
        }
    }).$mount("#app");
