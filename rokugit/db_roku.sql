...
--
-- Table structure for table `tbl_channelA`
--

CREATE TABLE `tbl_channelA` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_channelA`
--

INSERT INTO `tbl_channelA` (`id`, `name`, `year`, `description`, `image`) VALUES
...
--
-- Table structure for table `tbl_channelK`
--

CREATE TABLE `tbl_channelK` (
  `id` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `description` text NOT NULL,
  `image` varchar(50) NOT NULL
...
--
-- Dumping data for table `tbl_channelK`
--

INSERT INTO `tbl_channelK` (`id`, `name`, `description`, `image`) VALUES
...
--
-- Indexes for table `tbl_channelA`
--
ALTER TABLE `tbl_channelA`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_channelK`
--
ALTER TABLE `tbl_channelK`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_channelA`
--
ALTER TABLE `tbl_channelA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_channelK`
--
ALTER TABLE `tbl_channelK`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
